...
namespace SiiTaxi.Providers
{
    public class Messages
    {
        ...
        public const string AddNewApproverFailed = "Problem z dodaniem nowej osoby potwierdzającej.";
        ...
        public const string JoinedAlready = "Już jesteś pasażerem tego przejazdu!";
